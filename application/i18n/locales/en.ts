...
const en: Messages = {
  ...
  'snippets.field.scriptPlaceholder': 'ls -l',
  ...
  'snippets.view.tree': 'Tree',
  'snippets.targets.hosts': 'Hosts',
  'snippets.targets.groups': 'Groups',
  'snippets.targets.addHosts': 'Add Hosts',
  'snippets.targets.addGroups': 'Add Groups',
  'snippets.targets.selectHosts': 'Select Hosts',
  'snippets.targets.selectGroups': 'Select Groups',
  'snippets.targets.groupHosts': '{count} host(s)',
  'snippets.targets.noGroups': 'No groups available',
  ...
  'snippets.packageDialog.validation': 'Package names can contain letters, numbers, hyphens, underscores, and forward slashes. Can optionally start with /',
