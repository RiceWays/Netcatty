...
const zhCN: Messages = {
  ...
  'snippets.view.tree': '树形',
  'snippets.targets.hosts': '主机',
  'snippets.targets.groups': '分组',
  'snippets.targets.addHosts': '添加主机',
  'snippets.targets.addGroups': '添加分组',
  'snippets.targets.selectHosts': '选择主机',
  'snippets.targets.selectGroups': '选择分组',
  'snippets.targets.groupHosts': '{count} 台主机',
  'snippets.targets.noGroups': '没有可用的分组',
  ...
  'snippets.packageDialog.validation': '代码包名称可以包含字母、数字、连字符、下划线和正斜杠。可以选择以 / 开头',
